...
Larger values produce shorter encoded strings for long inputs (e.g., UUIDs). See [Hex Encoding Features](../advanced-topics.md#hex-encoding-features-experimental) for detailed examples and optimization guidance.