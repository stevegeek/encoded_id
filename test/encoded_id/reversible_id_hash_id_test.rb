...
class ReversibleIdHashIdTest < Minitest::Test
  def test_it_raises_with_invalid_salt
    assert_raises ::EncodedId::InvalidConfigurationError do
      ::EncodedId::ReversibleId.hashid(salt: 123)
    end
  end

  def test_it_raises_with_invalid_salt_length
    assert_raises ::EncodedId::InvalidConfigurationError do
      ::EncodedId::ReversibleId.hashid(salt: "1")
    end
  end

  def test_it_encodes_an_integer_id
    id = 123
    coded = ::EncodedId::ReversibleId.hashid(salt: salt).encode(id)
  ...
  def test_it_encodes_differently_with_different_salt
    id = 123
    coded = ::EncodedId::ReversibleId.hashid(salt: salt).encode(id)
    coded2 = ::EncodedId::ReversibleId.hashid(salt: "another salt").encode(id)
    refute_equal coded2, coded
  end

  def test_it_encodes_with_custom_alphabet
    id = 123
    coded = ::EncodedId::ReversibleId.hashid(salt: salt, alphabet: ::EncodedId::Alphabet.new("0123456789abcdef")).encode(id)
  ...
  def test_it_encodes_with_custom_alphabet_as_array
    ...
    coded = ::EncodedId::ReversibleId.hashid(salt: salt, alphabet: a).encode(id)
    assert_equal "923b-a293", coded
  end
  ...
  def test_it_encodes_differently_with_different_alphabet
    id = 123
    coded = ::EncodedId::ReversibleId.hashid(salt: salt).encode(id)
    coded2 = ::EncodedId::ReversibleId.hashid(salt: salt, alphabet: ::EncodedId::Alphabet.new("0123456789abcdef")).encode(id)
    refute_equal coded2, coded
  end

  def test_it_encodes_with_custom_length
    id = 123
    coded = ::EncodedId::ReversibleId.hashid(salt: salt, min_length: 4).encode(id)
    assert_equal "w9z2", coded

    coded = ::EncodedId::ReversibleId.hashid(salt: salt, min_length: 16).encode(id)
    assert_equal "8kdx-p5w9-z27j-4aqv", coded
  end

  def test_it_raises_with_zero_length
    assert_raises ::EncodedId::InvalidConfigurationError do
      ::EncodedId::ReversibleId.hashid(salt: salt, min_length: 0)
    end
  end

  def test_it_raises_with_invalid_length
    assert_raises ::EncodedId::InvalidConfigurationError do
      ::EncodedId::ReversibleId.hashid(salt: salt, min_length: "foo")
    end
  end

  def test_it_raises_with_invalid_max_length
    assert_raises ::EncodedId::InvalidConfigurationError do
      ::EncodedId::ReversibleId.hashid(salt: salt, max_length: -1)
    end
  end

  def test_it_raises_with_invalid_max_length_type
    assert_raises ::EncodedId::InvalidConfigurationError do
      ::EncodedId::ReversibleId.hashid(salt: salt, max_length: "foo")
    end
  end

  def test_it_raises_with_invalid_inputs_length
    assert_raises ::EncodedId::InvalidConfigurationError do
      ::EncodedId::ReversibleId.hashid(salt: salt, max_inputs_per_id: 0)
    end
  end

  def test_it_raises_with_invalid_inputs_length_type
    assert_raises ::EncodedId::InvalidConfigurationError do
      ::EncodedId::ReversibleId.hashid(salt: salt, max_inputs_per_id: "foo")
    end
  end

  def test_it_raises_with_invalid_alphabet
    assert_raises ::EncodedId::InvalidAlphabetError do
      ::EncodedId::ReversibleId.hashid(salt: salt, alphabet: 1234)
    end
  end

  def test_it_raises_with_blank_alphabet
    assert_raises ::EncodedId::InvalidAlphabetError do
      ::EncodedId::ReversibleId.hashid(salt: salt, alphabet: nil)
    end
  end

  def test_it_raises_with_negative_id
    assert_raises ::EncodedId::InvalidInputError do
      ::EncodedId::ReversibleId.hashid(salt: salt).encode(-1)
    end
  end

  def test_it_raises_with_empty_array
    assert_raises ::EncodedId::InvalidInputError do
      ::EncodedId::ReversibleId.hashid(salt: salt).encode([])
    end
  end

  def test_it_decodes_back_to_an_integer_id
    coded = "p5w9-z27j"
    id = ::EncodedId::ReversibleId.hashid(salt: salt).decode(coded)
    assert_equal [123], id
  end

  def test_it_decodes_back_to_an_integer_id_with_case_insensitivity
    coded = "P5w9-z27j"
    id = ::EncodedId::ReversibleId.hashid(salt: salt).decode(coded, downcase: true)
    assert_equal [123], id
  end
  ...
  def test_it_correctly_decodes_encodedids_with_case_sensitivity
    ...
    enc = ::EncodedId::ReversibleId.hashid(salt: salt, alphabet: a)
  ...
  def test_it_supports_alternate_character_mapping
    id = 8563432
    coder = ::EncodedId::ReversibleId.hashid(salt: salt, alphabet: ::EncodedId::Alphabet.new("!@#$%^&*()+-={}~", {"_" => "-"}), split_with: "F")
  ...
  def test_it_allows_nil_for_character_equivalences
    id = 8563432
    coder = ::EncodedId::ReversibleId.hashid(salt: salt, alphabet: ::EncodedId::Alphabet.new("!@#$%^&*()+-={}~", nil), split_with: "F")
    coded = coder.encode(id)
    assert_equal "+={+F~-~}", coded
  end
  ...
  def test_it_encodes_with_no_separator_if_nil_split_at
    id = "123"
    coded = ::EncodedId::ReversibleId.hashid(salt: salt, split_at: nil).encode(id)
    assert_equal "p5w9z27j", coded
  end

  def test_it_encodes_with_no_separator_if_nil_split_with
    id = "123"
    coded = ::EncodedId::ReversibleId.hashid(salt: salt, split_with: nil, split_at: 3).encode(id)
    assert_equal "p5w9z27j", coded
  end

  def test_it_raises_with_invalid_split_at
    assert_raises ::EncodedId::InvalidConfigurationError do
      ::EncodedId::ReversibleId.hashid(salt: salt, split_at: -1)
    end
  end

  def test_it_raises_with_invalid_split_at_type
    assert_raises ::EncodedId::InvalidConfigurationError do
      ::EncodedId::ReversibleId.hashid(salt: salt, split_at: "r")
    end
  end

  def test_it_encodes_with_custom_separator
    id = "123"
    coded = ::EncodedId::ReversibleId.hashid(salt: salt, split_with: "++").encode(id)
    assert_equal "p5w9++z27j", coded
  end

  def test_it_encodes_with_custom_separator_at_custom_point
    id = "123"
    coded = ::EncodedId::ReversibleId.hashid(salt: salt, split_with: "++", split_at: 5).encode(id)
    assert_equal "p5w9z++27j", coded
  end

  def test_it_encodes_with_custom_separator_at_custom_point_past_string_length
    id = "123"
    coded = ::EncodedId::ReversibleId.hashid(salt: salt, split_with: "++", split_at: 8).encode(id)
    assert_equal "p5w9z27j", coded
  end

  def test_it_raises_with_invalid_separator
    assert_raises ::EncodedId::InvalidConfigurationError do
      ::EncodedId::ReversibleId.hashid(salt: salt, split_with: 123)
    end
  end

  def test_it_raises_when_separator_in_alphabet
    assert_raises EncodedId::InvalidConfigurationError do
      ::EncodedId::ReversibleId.hashid(salt: salt, split_with: "a")
    end
  end
  ...
  def test_it_decodes_with_nil_split_with
    coded = "p5w9z27j"
    id = ::EncodedId::ReversibleId.hashid(salt: salt, split_with: nil).decode(coded)
    assert_equal [123], id
  end

  def test_it_decodes_with_nil_split_with_and_case_insensitivity
    coded = "P5w9z27J"
    id = ::EncodedId::ReversibleId.hashid(salt: salt, split_with: nil).decode(coded, downcase: true)
    assert_equal [123], id
  end
  ...
  def test_it_encodes_multiple_ids_with_different_split
    id = [78, 45]
    coded = ::EncodedId::ReversibleId.hashid(salt: salt, min_length: 16, split_at: 8).encode(id)
    assert_equal "z36m7aq6-0zqwvj2k", coded
  end

  def test_it_encodes_multiple_ids_with_different_alphabet
    id = [78, 45]
    coded = ::EncodedId::ReversibleId.hashid(salt: salt, min_length: 16, alphabet: ::EncodedId::Alphabet.new("0123456789abcdef")).encode(id)
    assert_equal "d48e-636e-8069-32ab", coded
  end

  def test_it_encodes_multiple_ids_with_custom_max_length
    id = [78, 45, 57]
    coded = ::EncodedId::ReversibleId.hashid(salt: salt, max_length: 16).encode(id)
  ...
  def test_it_raises_when_encoding_size_exceeds_max_length
    ...
    assert_raises ::EncodedId::EncodedIdLengthError do
      ::EncodedId::ReversibleId.hashid(salt: salt, max_length: 8).encode(id)
    end
  end
  ...
  def test_it_raises_when_hash_format_is_broken
    ...
    assert_raises EncodedId::EncodedIdFormatError do
      ::EncodedId::ReversibleId.hashid(salt: salt).decode(coded)
    end
  end
  ...
  def test_it_raises_when_input_exceeds_max_length_for_decode
    coded = "ogf-w$5^5"
    assert_raises EncodedId::EncodedIdFormatError do
      ::EncodedId::ReversibleId.hashid(salt: salt, max_length: 6).decode(coded)
    end
  end

  def test_it_encodes_hexadecimal
    id = "f1"
    coded = ::EncodedId::ReversibleId.hashid(salt: salt).encode_hex(id)
    assert_equal "zryg-pey4", coded
  end

  def test_it_decodes_hexadecimal
    coded = "zryg-pey4"
    id = ::EncodedId::ReversibleId.hashid(salt: salt).decode_hex(coded)
    assert_equal ["f1"], id
  end

  def test_it_decodes_hexadecimal_with_nil_split_with
    coded = "zrygpey4"
    id = ::EncodedId::ReversibleId.hashid(salt: salt, split_with: nil).decode_hex(coded)
    assert_equal ["f1"], id
  end

  def test_it_decodes_hexadecimal_with_nil_split_with_and_case_insensitivity
    coded = "ZrygPEY4"
    id = ::EncodedId::ReversibleId.hashid(salt: salt, split_with: nil).decode_hex(coded, downcase: true)
    assert_equal ["f1"], id
  end
  ...
  def test_it_encodes_multiple_hexadecimal_as_uuids
    ...
    coded = ::EncodedId::ReversibleId.hashid(salt: salt, split_at: 16, max_length: nil).encode_hex(id)
  ...
  def test_it_raises_when_input_exceeds_max_length_for_decode_hex
    coded = "qrrgfpbqcjnm2t6p-zqc83gncbqjgfbne-qcea2msrx6b026d3-s444ruvz35c6m8rs-3ernu4pbburzemur-5g4hjkn9uvn8ktqv-xef89x8tdkeeur3a-gfgqkahjb64h69na"
    assert_raises EncodedId::EncodedIdFormatError do
      ::EncodedId::ReversibleId.hashid(salt: salt, max_length: 72).decode(coded)
    end
  end

  def test_it_raises_with_invalid_hex_digit_encoding_group_size
    assert_raises ::EncodedId::InvalidConfigurationError do
      ::EncodedId::ReversibleId.hashid(salt: salt, hex_digit_encoding_group_size: 123)
    end
  end

  def test_it_raises_with_zero_hex_digit_encoding_group_size
    assert_raises ::EncodedId::InvalidConfigurationError do
      ::EncodedId::ReversibleId.hashid(salt: salt, hex_digit_encoding_group_size: 0)
    end
  end
  ...
  def test_it_encodes_hex_with_different_hex_digit_encoding_group_size
    ...
    coded = ::EncodedId::ReversibleId.hashid(salt: salt, hex_digit_encoding_group_size: 8).encode_hex(id)
  ...
  def test_it_encodes_hex_with_different_hex_digit_encoding_group_size_when_long_inputs
    id = ["9a566b8b-8618-42ab-8db7-a5a0276401fd", "59f3905a-e704-4714-b42e-960c82b699fe", "9c0498f3-639d-41ed-87c3-715c61e14798"]
    coded = ::EncodedId::ReversibleId.hashid(salt: salt, max_length: nil).encode_hex(id)
    ...
    coded = ::EncodedId::ReversibleId.hashid(salt: salt, hex_digit_encoding_group_size: 10, max_length: nil).encode_hex(id)
  ...
  def test_it_encodes_hex_with_custom_max_length
    id = ["1", "c0"]
    coded = ::EncodedId::ReversibleId.hashid(salt: salt, max_length: 32).encode_hex(id)
  ...
  def test_it_raises_when_hex_encoding_size_exceeds_max_length
    id = ["9a566b8b-8618-42ab-8db7-a5a0276401fd", "59f3905a-e704-4714-b42e-960c82b699fe", "9c0498f3-639d-41ed-87c3-715c61e14798"]
    assert_raises ::EncodedId::EncodedIdLengthError do
      ::EncodedId::ReversibleId.hashid(salt: salt, max_length: 8).encode_hex(id)
    end
  end
  ...
  def test_it_raises_when_encode_amount_of_id_provided_exceeds_max_inputs
    id = ["1", "2"]
    assert_raises ::EncodedId::InvalidInputError do
      ::EncodedId::ReversibleId.hashid(salt: salt, max_inputs_per_id: 1).encode(id)
    end
  end
  ...
  def test_it_raises_when_encode_hex_amount_of_id_provided_exceeds_max_inputs
    ...
    assert_raises ::EncodedId::InvalidInputError do
      ::EncodedId::ReversibleId.hashid(salt: salt, max_inputs_per_id: 7).encode_hex(id)
    end
  end
